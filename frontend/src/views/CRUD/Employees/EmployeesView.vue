...
import TableEmployees from "@/components/Employees/TableEmployees.vue";
...
const deleteFilter = (index) => {
  ...
  generateQuery();
  employeesStore.fetch(null, query.value);
}
...
<template>
  ...
  <SectionHeroBar>Employees</SectionHeroBar>
  <SectionMain>
    <BaseButtons>
      <BaseButton
        color="default"
  ...
  <SectionMain>
    <CardBox
      ...
      has-table
    >
      <TableEmployees checkable :sortTitle="sortTitle" :sortDirection="sortDirection" @sort="sortTable($event)" />
    </CardBox>
