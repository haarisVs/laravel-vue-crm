...
/* Fetch data */
const empployeesStore = useEmployeesStore()
empployeesStore.fetch()

/* Delete item */
const deleteItem = () => {
  empployeesStore.deleteItem(currentId.value)
}

const items = computed(() => empployeesStore.data)
...
<template>
  ...
  <table>
    ...
    <tr
      ...
      :key="client.id"
      @click="$router.push(`/employees/${client.id}/edit`)"
    >
      <TableCheckboxCell
        v-if="checkable"
